...
// each player and determine wich player one the roll.
function rollForTurn() {
  ...
  for (i=0;i<xArray.length;i++) {
    ...
    var pOne = xArray[0];
    var pTwo = xArray[1];
    if (pOne == pTwo) { // rigging roll on tie to avoid bog in code. Need to address this later...
      var pOne = 1;
      var pTwo = 2;
    }
...
function stopEnabled(btn) {
  ...
  btn.style.backgroundCol,or = "rgb(256, 51, 51)";
  btn.disabled = false;
}
...
function determineAvatar() {
  ...
  console.log('DETERMINEAVATAR: '+paintAvatar);
...
function avatarPlaced() {
  ...
  // check if there is alread a winner...if there is, then don't continue the game
  ...
  console.log("avatarPlaced, active Player:"+activePlayer+", New Player: "+showPlayer.innerHTML);
  console.log("showPlayer innerHTML"+document.getElementById('showPlayer').innerHTML);
...
// square has already been assigned. If not, record new square with the assigned avatar.
...
function glowBoard(pos) {
  ...
  for (var i=0;i<squares.length;i++) {
    if (i == index0) {
      ...
      setTimeout(function() {bg2.style.backgroundColor = 'rgb(122, 238, 66)';}, 400);
...
//these functions will produce game sounds depening on the occasion
...
function blink() {
  ...
  setTimeout(function() {body.style.backgroundColor = '#e694f7';}, 600);
...
// ------------------------------------------------------------- (line 378)
// These functions are the algorithms to find all the conditons
// -------------------------------------------------------------
...
function checkWinCon7(info,squareArray) {
  ...
  if (match6Avatar != undefined && match4Avatar != undefined && match2Avatar != undefined) {
    if (match4Avatar == match4Avatar && match6Avatar == match2Avatar) {
      winDetected = "win";
    }
  }
...
// checking for wincon squares 048 (line 550)
function checkWinCon8(info,squareArray) {
  ...
  if (match0Avatar != undefined && match4Avatar != undefined && match8Avatar != undefined) {
    if (match0Avatar == match4Avatar && match8Avatar == match2Avatar) {
      winDetected = "win";
    }
  }
...
function square1Animate() {
  ...
  if (activePlayer != "Game Stopped") { // if game has not yet started, prevent avatar placement
    ...
    if (verdict == undefined) { // if verdict is empty, then the square is unoccupied.
      ...
      console.log("pa = "+paintAvatar);
      var selected = document.getElementsByClassName(paintAvatar)[0]; // paintAvatar
      if (paintAvatar == "O") { // change these all the ternary statements instead
...
function square2Animate() {
  ...
  if (activePlayer != "Game Stopped") { // if game has not yet started, prevent avatar placement
    ...
    if (verdict == undefined) { // if verdict is empty, then the square is unoccupied.
      var paintAvatar = determineAvatar(); // get the correct avatar to paint for the active player
      var selected = document.getElementsByClassName(paintAvatar)[1]; // paintAvatar
      if (paintAvatar == "O") { // change these all the ternary statements instead
        animateO(selected); // call function to animate O
      } else if (paintAvatar == "X") {
        animateX(selected); // call function to animate X
...
function square3Animate() {
  ...
  if (activePlayer != "Game Stopped") { // if game has not yet started, prevent avatar placement
    ...
    if (verdict == undefined) { // if verdict is empty, then the square is unoccupied.
      var paintAvatar = determineAvatar(); // get the correct avatar to paint for the active player
      var selected = document.getElementsByClassName(paintAvatar)[2]; // paintAvatar
      if (paintAvatar == "O") { // change these all the ternary statements instead
        animateO(selected); // call function to animate O
      } else if (paintAvatar == "X") {
        animateX(selected); // call function to animate X
...
function square4Animate() {
  ...
  if (activePlayer != "Game Stopped") { // if game has not yet started, prevent avatar placement
    ...
    if (verdict == undefined) { // if verdict is empty, then the square is unoccupied.
      var paintAvatar = determineAvatar(); // get the correct avatar to paint for the active player
      var selected = document.getElementsByClassName(paintAvatar)[3]; // paintAvatar
      if (paintAvatar == "O") { // change these all the ternary statements instead
        animateO(selected); // call function to animate O
      } else if (paintAvatar == "X") {
        animateX(selected); // call function to animate X
...
function square5Animate() {
  ...
  if (activePlayer != "Game Stopped") { // if game has not yet started, prevent avatar placement
    ...
    if (verdict == undefined) { // if verdict is empty, then the square is unoccupied.
      var paintAvatar = determineAvatar(); // get the correct avatar to paint for the active player
      var selected = document.getElementsByClassName(paintAvatar)[4]; // paintAvatar
      if (paintAvatar == "O") { // change these all the ternary statements instead
        animateO(selected); // call function to animate O
      } else if (paintAvatar == "X") {
        animateX(selected); // call function to animate X
...
function square6Animate() {
  ...
  if (activePlayer != "Game Stopped") { // if game has not yet started, prevent avatar placement
    ...
    if (verdict == undefined) { // if verdict is empty, then the square is unoccupied.
      var paintAvatar = determineAvatar(); // get the correct avatar to paint for the active player
      var selected = document.getElementsByClassName(paintAvatar)[5]; // paintAvatar
      if (paintAvatar == "O") { // change these all the ternary statements instead
        animateO(selected); // call function to animate O
      } else if (paintAvatar == "X") {
        animateX(selected); // call function to animate X
...
function square7Animate() {
  ...
  if (activePlayer != "Game Stopped") { // if game has not yet started, prevent avatar placement
    ...
    if (verdict == undefined) { // if verdict is empty, then the square is unoccupied.
      var paintAvatar = determineAvatar(); // get the correct avatar to paint for the active player
      var selected = document.getElementsByClassName(paintAvatar)[6]; // paintAvatar
      if (paintAvatar == "O") { // change these all the ternary statements instead
        animateO(selected); // call function to animate O
      } else if (paintAvatar == "X") {
        animateX(selected); // call function to animate X
...
function square8Animate() {
  ...
  if (activePlayer != "Game Stopped") { // if game has not yet started, prevent avatar placement
    ...
    if (verdict == undefined) { // if verdict is empty, then the square is unoccupied.
      var paintAvatar = determineAvatar(); // get the correct avatar to paint for the active player
      var selected = document.getElementsByClassName(paintAvatar)[7]; // paintAvatar
      if (paintAvatar == "O") { // change these all the ternary statements instead
        animateO(selected); // call function to animate O
      } else if (paintAvatar == "X") {
        animateX(selected); // call function to animate X
...
function square9Animate() {
  ...
  if (activePlayer != "Game Stopped") { // if game has not yet started, prevent avatar placement
    ...
    if (verdict == undefined) { // if verdict is empty, then the square is unoccupied.
      var paintAvatar = determineAvatar(); // get the correct avatar to paint for the active player
      var selected = document.getElementsByClassName(paintAvatar)[8]; // paintAvatar
      if (paintAvatar == "O") { // change these all the ternary statements instead
        animateO(selected); // call function to animate O
      } else if (paintAvatar == "X") {
        animateX(selected); // call function to animate X
